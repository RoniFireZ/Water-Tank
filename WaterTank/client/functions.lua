PurchaseDrink = function()
    ESX.TriggerServerCallback("watertank:validatePurchase", function(validated)
        if validated then
            ESX.ShowNotification("You bought a bottle of water.")

            Drink()
        else
            ESX.ShowNotification("You don't have enough cash, please try again.")
        end
    end)
end
